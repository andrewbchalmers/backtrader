...
end_date = "2026-02-02"    # End of test period
...
strategy_params = {
    ...
    # Label Settings
    'label_lookahead': 3,            # Bars to look forward (default 4, try 8-12)
    'label_dead_zone': 0.15,         # Min ATR move for label (default 0.5, try 0.25)
