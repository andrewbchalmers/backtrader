...
CONFIG = {
    ...
    'param_grid': {
        ...
        'use_kernel_exit': [True],         # Enable kernel line exit
...
PARAM_NAMES = [
    ...
    'use_regime_direction', 'regime_stability_min',
...
def run_walkforward_optimization(config):
    ...
    for period_idx, period_info in enumerate(periods):
        ...
        # Rank by composite_score (balances return, Sharpe, stock win rate, drawdown)
        best_params = max(filtered_results.items(), key=lambda x: x[1]['composite_score'])
