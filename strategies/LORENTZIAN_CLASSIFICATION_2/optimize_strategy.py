"""
Walk-Forward Optimization for Lorentzian Classification Strategy
...
# Define parameter names for the strategy
PARAM_NAMES = [
...
def run_walkforward_optimization(config):
    ...
    print("\n" + "="*70)
    print("WALK-FORWARD OPTIMIZATION - LORENTZIAN CLASSIFICATION")
    print("="*70)
    ...
    for period_idx, period_info in enumerate(periods):
        ...
        print(f"   Features:")
        print(f"     F1: {params_dict['f1_type']}({params_dict['f1_param_a']}, {params_dict['f1_param_b']})")
        print(f"     F2: {params_dict['f2_type']}({params_dict['f2_param_a']}, {params_dict['f2_param_b']})")
        print(f"     F3: {params_dict['f3_type']}({params_dict['f3_param_a']}, {params_dict['f3_param_b']})")
        print(f"     F4: {params_dict['f4_type']}({params_dict['f4_param_a']})")
        if params_dict['feature_count'] >= 5:
            print(f"     F5: {params_dict['f5_type']}({params_dict['f5_param_a']}, {params_dict['f5_param_b']})")
        print(f"   Filters:")
